...
> Phạm vi hiện tại của prototype Unity: Sprint, Badminton và Football. Sprint có thể chơi; hai môn còn lại đang khóa trên bản đồ.
...
- `Bootstrap`, `Map`, `MG_Sprint`, `MG_Badminton`, `MG_Football`, `Punishment`, `GameOver`.
